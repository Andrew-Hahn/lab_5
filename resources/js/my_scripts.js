...
function loadStatsPage() {
					...
					changeLosses.innerHTML += homeLosses;
					changeWin.innerHTML += homeWins;
}
/*
...
function loadPlayersPage()
{
   ...
   for(var i = 0; i<players.length;i++)
   {
       ...
       insertName = insertName + "<a class = 'dropdown-item' href='#' onclick = 'switchPlayers("+ i +")'>" + playerName +"</a>"
   }
   menu.innerHTML=insertName;
...
function switchPlayers(playerNum)
{
   ...
   var passYardsAvg =Math.floor(players[playerNum].pass_yards/players[playerNum].games_played);
   var rushYardsAvg=Math.floor(players[playerNum].rushing_yards/players[playerNum].games_played);
   var recYardsAvg =Math.floor(players[playerNum].receiving_yards/players[playerNum].games_played);
   document.getElementById("avg_p_yards").innerHTML= passYardsAvg;
   document.getElementById("avg_r_yards").innerHTML= rushYardsAvg;
   document.getElementById("avg_rec_yards").innerHTML= recYardsAvg;
}
